// // src/components/modules/administracion/submodules/gastos-administrativos/submodules/nomina-personal/submodules/nomina/submodules/asistencia-diaria/components/HistorialAsistencias.jsx
// import React, { useState } from 'react'
// import './HistorialAsistencias.css'

// const HistorialAsistencias = ({ asistencias, employees, onDateSelect }) => {
...
// // En HistorialAsistencias.jsx - actualizar la función getEmpleadoInfo
// const getEmpleadoInfo = (empleadoId) => {
//   return employees.find(emp => emp.id === empleadoId) || {
...
//                     return (
//                       <div key={registro.empleadoId} className="employee-detail">
//                         <span className="employee-name">{registro.nombre}</span>
//                         <span className="employee-cedula">C.I. {registro.cedula}</span>
//                         <span className={`attendance-status ${registro.asistio ? 'present' : 'absent'}`}>
